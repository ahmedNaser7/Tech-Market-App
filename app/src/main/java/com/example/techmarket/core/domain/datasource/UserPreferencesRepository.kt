...
interface UserPreferencesRepository {
    suspend fun getUserDetails():Result<Flow<UserDetailsPreferences>,AuthError>
    suspend fun updateUserDetails(userDetails: UserDetailsPreferences):Result<Boolean,AuthError>
}