...
import com.example.techmarket.core.data.local.DataStoreKeys.TECH_MARKET_PREFERENCES
import com.example.techmarket.core.data.local.DataStoreKeys.USER_DETAILS_PREFERENCES_PB
...
object DataStoreKeys {
        const val TECH_MARKET_PREFERENCES = "e_commerce_preferences"
        val IS_USER_LOGGED_IN = booleanPreferencesKey("is_user_logged_in")
        val USER_ROLE = stringPreferencesKey("role")
        val USER_DETAILS_PREFERENCES_PB = "user_details_preferences.pb"
}

val Context.appDateStore:DataStore<Preferences> by preferencesDataStore(name =TECH_MARKET_PREFERENCES )
